...
result = plausible_api.create_site_goal(domain="tokopedia.com", goal_type="event", event_name="Login")
print(result)

result = plausible_api.create_site_goal(domain="tokopedia.com", goal_type="page", page_path="/signup")
print(result)
